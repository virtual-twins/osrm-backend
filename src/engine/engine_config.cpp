...
bool EngineConfig::IsValid() const
{
    const bool all_path_are_empty =
        storage_config.base.empty() && storage_config.ram_index_path.empty() &&
        storage_config.file_index_path.empty() && storage_config.nodes_data_path.empty() &&
        storage_config.edges_data_path.empty() && storage_config.geometries_path.empty();
